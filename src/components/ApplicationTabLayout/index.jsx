...
import { CheckCircle, XCircle, Clock, AlertCircle, Trash2, MessageCircle, Eye } from 'lucide-react';
import ApplicationComments from '../ApplicationComments';

const ApplicationTabLayout = ({ studentId }) => {
    ...
    <div className="h-full flex flex-col">
      ...
      {student && (
        <div className="bg-white rounded-lg shadow-md p-4 mb-4">
          <h2 className="text-xl font-bold text-gray-900 mb-2">Applied Programs</h2>
